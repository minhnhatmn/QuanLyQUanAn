...
{
    public partial class FormPhucVu : Form
    {
        ...
        private void FormPhucVu_Load(object sender, EventArgs e)
        {
            label1.Text = txtval;
        }

        private void FormPhucVu_FormClosed(object sender, FormClosedEventArgs e)
        {
